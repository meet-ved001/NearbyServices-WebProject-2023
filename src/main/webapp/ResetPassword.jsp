                        ...
                        <div class="control-group">
                            <input type="password" class="form-control" placeholder="Enter your CPasword"
                                name="Cpassword" />
                                    ...
                                    <button type="submit" name="action" value="Confirm" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" fdprocessedid="d538fo">Confirm</button>
                                    </div>
