                        ...
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" action="ForgotController" method="post" novalidate="novalidate">
                                <div class="col-md-12 form-group p_star">
                                    <input type="email" class="form-control " id="name" style="height: 60px" name="emailaddress" value=""
                                        placeholder="Enter Email">
                                </div>
                                
                                <div class="col-md-12 form-group">
                                    <button type="submit" name="action" value="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" fdprocessedid="d538fo">Submit</button>
