		...
		<div class="col-md-9" style="width:740px; margin-top: 44px">
			<div class="contact-form">
				<div class="form-group">
				  ...
				  <div class="col-sm-10">          
					<input  type="text" value="" class="form-control" id="fname" placeholder="Enter full Name" name="fullname">
				  </div>
				</div>
				  ...
				  <div class="col-sm-10">
					<input type="email"  class="form-control" value="" id="email" placeholder="Enter your Email" name="email">
				  </div>
				</div>
              ...
              style="padding-left: 2.5rem; padding-right: 2.5rem;margin-left: 97px;width: 235px" name="action" value="feedback1">Submit feedback form</button>
